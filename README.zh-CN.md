...
每次升级暂停游戏，从 **15 张卡池随机抽 3 张**。所有卡都能叠加——基础强化、元素弹头、追踪/波浪弹道再选同卡即升级（最高 Lv.3）；选不同的元素/弹道则随时切换，各元素/弹道的等级独立保留，卡面上会标注"切换"：
...
元素流派：火烧密集阵、雷点分散兵、冰风筝追兵、风推走位——流派之间随时可换，等级不丢。卡池全满的超后期，会出现"紧急维修"补位卡，让升级始终有意义。
