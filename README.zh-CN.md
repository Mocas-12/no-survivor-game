...
每种 Boss 的弹幕都有专属弹形与颜色，弹形即身份：毁灭者**赤红重弹**、拦截者**紫色飞镖**、要塞**翠绿激光矢**、猎手**金色猎刺**（带微光尾迹）、幻影**青蓝水晶棱刺**；血量过半狂暴时，机体外圈会泛起红色脉冲环。
...
每次升级暂停游戏，从 **15 张卡池随机抽 3 张**。所有卡都能叠加——基础强化、元素弹头、波浪弹道再选同卡即升级（最高 Lv.3）；选不同的元素/弹道则随时切换，各元素/弹道的等级独立保留，卡面上会标注"切换"：
